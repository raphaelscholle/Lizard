...
ifeq ($(LICHEE_IC), $(filter $(LICHEE_IC), tv303-c1 tv303-c2 tv303-g1 tv303-g2))
	CEDARX_DEPENDENCIES += libdisplay
...
CEDARX_CONF_OPTS += CFLAGS="-D__ENABLE_ZLIB__ -D$(PLATFORM_CONF)"
CEDARX_CONF_OPTS += CPPFLAGS="-D__ENABLE_ZLIB__ -D$(PLATFORM_CONF)"
...
define CEDARX_INSTALL_TARGET_CMDS
	...
	cp -rf $(@D)/conf/${TARGET_IC}_cedarx.conf $(TARGET_DIR)/etc/cedarx.conf
endef
